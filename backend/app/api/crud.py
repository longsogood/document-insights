...
# id=UUID('e35b535e-beda-4906-9887-059f8f1f7e00') 
# created_at=datetime.datetime(2024, 6, 15, 4, 13, 30, 830096) 
# updated_at=datetime.datetime(2024, 6, 15, 4, 13, 30, 830096) 
# url='http://llama-app-web-assets-local.s3-website.localhost.localstack.cloud:4566/sec-edgar-filings/0001018724/10-K/0001018724-24-000008/primary-document.pdf' 
# metadata_map={<DocumentMetadataKeysEnum.SEC_DOCUMENT: 'sec_document'>: {'cik': '0001018724', 'year': 2023, 'doc_type': '10-K', 'company_name': 'Amazon.com Inc.', 'company_ticker': 'AMZN', 'accession_number': '0001018724-24-000008', 'filed_as_of_date': '2024-02-02T00:00:00', 'date_as_of_change': '2024-02-01T00:00:00', 'period_of_report_date': '2023-12-31T00:00:00'}}