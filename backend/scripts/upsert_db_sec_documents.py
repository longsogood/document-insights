...
from fire import Fire # Tạo CLI command
from tqdm import tqdm
import asyncio # sử dụng cho các hoạt động không đồng bộ
from pytickersymbols import PyTickerSymbols # tìm nạp dữ liệu chứng khoán
